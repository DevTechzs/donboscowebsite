...
class Session
{
	...
	function setLoginAttempt(){
		...
		$query = "INSERT INTO Login_Attempt(IPAddress, Time) VALUES(:IPAddress, current_timestamp())";
		DBController::ExecuteSQL($query, $param);
	}
	...
	function getLoginAttempt(){
		...
		$query = "SELECT COUNT(*) FROM Login_Attempt WHERE IPAddress =:IPAddress AND Login_Attempt.Time > DATE_SUB(current_timestamp(), INTERVAL 30 MINUTE); ";
		DBController::ExecuteSQL($query, $param);
	}
