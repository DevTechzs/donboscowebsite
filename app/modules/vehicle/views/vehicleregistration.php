                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                              Requested For Registering Vehicle
                            </div>
                            ...
                            <div class="modal fade" id="approved">
                                <div class="modal-dialog modal-xs">
                                    <div class="modal-content">
                                        <form method="post">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Approved Vehicle</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="driver_licence_no">Remarks</label>
                                                            <input type="text" id="remarks" class="form-control" placeholder="Remarks" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer ">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary" id="btn-approvedvehicle">Approved </button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="rejected">
                                <div class="modal-dialog modal-xs">
                                    <div class="modal-content">
                                        <form method="post">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Vehicle Request Reject</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="driver_licence_no">Rejected Remarks</label>
                                                            <input type="text" id="rejectedremarks" class="form-control" placeholder="Remarks" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer ">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-primary" id="btn-rejectedvehicle">Rejected</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script>
    $(function() {
        ...
        getVehicleModel();
        getLocation();
        getRequestedForRegisterVehicle();
        // getState();
        // getAllDistrict();
        // getDesignation();
    });
    ...
    function getRequestedForRegisterVehicle() {
        var obj = new Object();
        obj.Module = "Vehicle";
        obj.Page_key = "getRequestedForRegisterVehicle";
        var json = new Object();
        obj.JSON = json;
